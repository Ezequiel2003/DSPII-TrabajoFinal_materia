...
#out = cv2.VideoWriter('Prueba6_experimento.avi',fourcc, 30, (1280,480))
...
def seguidor_lineas():
    ...
    if(not curva_90_izq and not curva_90_der):
        ...
        if(brusco_izq and cont_izq and cont_der):
        ...
        elif(brusco_der and cont_izq and cont_der):
            #print("Brusco izquierdo")
...
#         cv2.line(imagen_final, (0,alto-100), (ancho-0,alto-100), (255,0,0),thickness = 5) #linea inferior
#         #cv2.line(imagen_final, (ancho,alto-100), (ancho-40,alto-350), (255,0,0),thickness = 5) #linea derecha
#         cv2.line(imagen_final, (ancho-0,alto-100), (ancho-0,alto-350), (255,0,0),thickness = 5) #linea derecha
#         #cv2.line(imagen_final, (ancho-600,alto-350), (ancho-40,alto-350), (255,0,0),thickness = 5) #linea superior
#         cv2.line(imagen_final, (ancho-630,alto-350), (ancho-10,alto-350), (255,0,0),thickness = 5) #linea superior
        ...
        cv2.line(imagen_final, (int(ancho/2),int(alto/2)-20),(int(ancho/2),int(alto/2)+20),(0,255,0),thickness=5)
